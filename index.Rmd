...
- RStudio is used for analyze the **correlationship** between different variables.

- Excel is usually used for **collect** and **input** data, and do some simple **caculation**. 
